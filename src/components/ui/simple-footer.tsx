...
export function Footer() {
	return (
		<footer className="relative w-full max-w-6xl mx-auto flex flex-col items-center justify-center rounded-t-4xl md:rounded-t-6xl border-t border-white/10 bg-black/20 backdrop-blur-xl px-6 py-12 lg:py-16 mt-20">
								...
								<ul className="space-y-3">
									{section.links.map((link) => (
										<li key={link.title}>
											<a
												href={link.href}
												className="text-gray-400 hover:text-white inline-flex items-center transition-all duration-300 text-sm group"
											>
												{link.icon && (
													<link.icon className="me-2 size-4 group-hover:text-blue-400 transition-colors" />
												)}
